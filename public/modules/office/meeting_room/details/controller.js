myApp.registerCtrl('meeting_room_details_controller', ['$filter', '$location', 'meeting_room_details_service', '$q', '$rootScope', '$scope', function ($filter, $location, meeting_room_details_service, $q, $rootScope, $scope) {
    /**declare variable */
...
myApp.registerCtrl('meeting_room_action_controller', ['meeting_room_service', '$q', '$rootScope', '$filter', '$location', 'languageValue', 'localStorage', '$timeout', function (meeting_room_service, $q, $rootScope, $filter, $location, $languageValue, $localStorage, $timeout) {
    ...
    /** init variable */
    {
        ctrl._ctrlName = "meeting_room_action_controller";
    ...
    function update_register_service() {
        ...
        meeting_room_service.update_register(dataUpdate).then(function () {
            dfd.resolve(true);
            $rootScope.$broadcast('room::access');
